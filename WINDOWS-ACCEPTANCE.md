...
Never attach `.env`, API keys, administrator passwords, or screenshots containing secrets. Automated checks do not close the product gates. Publish `v0.1.27.1` only after the install, product, restart, and preservation paths pass on the clean VM.
