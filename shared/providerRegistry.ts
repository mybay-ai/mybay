...
export const providerRegistry: Record<string, ProviderConfig> = {
  ...
  anthropic: {
    ...
    models: ["claude-fable-5", "claude-opus-5", "claude-sonnet-5", "claude-opus-4-8"],
    envPrefix: "ANTHROPIC",
    requiresApiKey: true,
  ...
  openrouter: {
    ...
    models: ["meta-llama/llama-3.3-70b-instruct", "anthropic/claude-3.5-sonnet", "deepseek/deepseek-chat", "google/gemini-2.5-flash"],
