...
export const CODEX_RUNTIME_RELEASES: readonly RuntimeReleaseDefinition[] = Object.freeze([
  freezeRelease({
    ...
    changelog: "Updates the pinned Codex CLI 0.154.0 bridge with trusted A2A tools, structured questions and bounded terminal-run cleanup.",
    changelogZh: "更新固定的 Codex CLI 0.154.0 bridge，加入可信 A2A 工具、结构化提问和有界终态 Run 清理。",
    isLatest: true,
    upgradeable: true,
