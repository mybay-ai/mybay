...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  INSTANCE_NOT_RUNNING: "实例尚未运行，请先启动实例后再进入对话。",
  INTERNAL_ROUTING_SECRET_MISSING: "内部路由密钥缺失，请检查本地部署配置。",
  INTERNAL_ROUTE_TIMEOUT: "实例内部对话路由响应超时，请稍后重试。",
  INTERNAL_ROUTE_CONNECT_FAILED: "无法连接实例内部对话端口，请检查容器状态。",
  ...
  UPSTREAM_FAILED: "Agent 执行意外中断，可能是 Runtime 重启、模型服务或网络异常。已有部分输出会保留，请检查实例状态后重试。",
  ...
  CODEX_AUTH_REQUIRED: "当前 Codex 实例需要重新连接 OpenAI OAuth，完成授权后再试。",
  HERMES_INTERNAL_API_KEY_MISSING: "实例内部 API Key 未配置，请重新部署或完善实例配置。",
  HERMES_API_AUTH_FAILED: "实例内部 API Key 校验失败，请检查实例配置后重试。",
  HERMES_API_NOT_READY: "Agent 对话服务仍在启动，请稍后重试。",
  HERMES_SESSION_CREATE_FAILED: "实例会话创建失败，请稍后重试。",
  HERMES_SESSION_REBIND_FAILED: "实例会话恢复失败，请刷新会话后重试。",
